                ...
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item page-item active ">
                            <a href="/client/#!" class="page-link">1</a>
                        </li>
                        <li class="page-item">
                            <a href="/client/#!" class="page-link">2</a>
                        </li>
                        <li class="page-item">
                            <a href="/client/#!" class="page-link">&raquo;</a>
                        </li>
                    </ul>
                </div>
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget widget-about">
                        ...
                        <ul class="list-inline social-icons mb-3">
                            ...
                            <li class="list-inline-item"><a href="/client/#"><i class="ti-facebook"></i></a></li>

                            <li class="list-inline-item"><a href="/client/#"><i class="ti-twitter-alt"></i></a></li>

                            <li class="list-inline-item"><a href="/client/#"><i class="ti-linkedin"></i></a></li>

                            <li class="list-inline-item"><a href="/client/#"><i class="ti-github"></i></a></li>

                            <li class="list-inline-item"><a href="/client/#"><i class="ti-youtube"></i></a></li>

                        </ul>
                        <a href="/client/about-me.html" class="btn btn-primary mb-2">About me</a>
                    </div>
                    ...
                    <div class="promotion">
                        ...
                        <div class="promotion-content">
                            ...
                            <a href="/client/https://themefisher.com/" class="btn btn-primary">Get Started</a>
                        </div>
                    </div>
